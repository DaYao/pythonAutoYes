...
class OrderOperation(BaseLogin,CreateStudentOrderPage,VerifyOrderPage,ChargeBackPage,OrderRefundPage,presentOrderPage,TransferOrderPage,HomePage):

    studentOrderName = 'lhf032201'
    transferNewStudent = 'lhf032202'
    ...
    def testPresentOrder(self):
        ...
        self.Present(self.studentOrderName)
        self.wait5
        self.PresentVerify(self.studentOrderName)

    def testTrasferOrder(self):
        self.Transfer(self.studentOrderName,self.transferNewStudent)
        self.wait5
        self.TransferVerify(self.studentOrderName)
